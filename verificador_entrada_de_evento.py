...
# verifica se a resposta é diferente de "sim" ou "não", se for diferente, pede para o usuário digitar novamente
...
# verifica duas condições ao mesmo tempo: se a idade é maior ou igual a 18 E se o ingresso foi pago
if idade >= 18 and ingressoPago == "sim":
    print("Entrada permitida. Bem-vindo ao evento,",nome)
else:
    print("Entrada não permitida.")
    # se as duas condições forem verdadeiras, a entrada é permitida, caso alguma das condições não seja atendida, a entrada é negada
